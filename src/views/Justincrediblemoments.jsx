...
export const Justincrediblemoments = () => {
    return (
        <>
            <AnimatePresence exitBeforeEnter>
                <section className={'w-screen h-screen relative bg-orange-800/50 dark:bg-orange-200/50 flex justify-center overflow-hidden'}>
                    {/*<CustomCursor/>*/}
                        ...
                        <div
                            ...
                            <div className={'z-10 absolute w-full h-fit top-10 sm:top-16 left-0 z-10 text-7xl font-black uppercase'}>
                                ...
                                <div className={'hidden sm:flex absolute top-0'}>
                                    <ParallaxText baseVelocity={-2}> {userData.projects[2].name} </ParallaxText>
                            ...
                            <img src={userData.projects[2].cover} className={'w-full h-full object-cover z-10 hover:scale-125 transition-transform duration-[1200ms] ease-in-out'}/>
                        </div>`
                        ...
                        <div className={'relative flex flex-col w-full h-1/3 px-2 sm:px-0 justify-between '}>
                            <div className={'w-full h-1/4  py-4 sm:py-10  flex items-center justify-between relative text-sm sm:text-md md:text-lg text-teal-800/30 dark:text-teal-200/50'}>
                                ...
                                <div className={'flex justify-between gap-4'}>
                                    <span>  {userData.projects[2].form} </span>
                                    <span>  {userData.projects[2].year}  </span>
                                </div>
                            </div>
                            <hr/>
                            <div className={'w-full h-full flex flex-col sm:flex-row relative pt-4 sm:pt-10 sm:pb-10 text-stone-600/70'}>
                                ...
                                <p className={'pl-0 sm:pl-4 pt-3 sm:pt-0 mt-6 sm:mt-0 text-lg sm:text-2xl w-full sm:text-right'}>
                                    All the beauty and glory of a not-so-average photography portfolio. Photos curated by
                                    <span className={'line-through italic text-teal-200/40 dark:text-teal-200/40 '}> unsplash </span>
                                    me
                                </p>
        ...
        //                         {/*<div style={{WebkitTextStrokeWidth:'1px', color:"transparent", WebkitTextStrokeColor:'#ffffff'}}> Blendify</div>*/}
        //                         <ParallaxText baseVelocity={-1}> {userData.projects[2].name} </ParallaxText>
        //                         <div className={'sm:hidden'}>
        //                             <ParallaxText baseVelocity={1}> {userData.projects[2].name} </ParallaxText>
        //                             <ParallaxText baseVelocity={-1}> {userData.projects[2].name} </ParallaxText>
        //                         </div>
        //                     </div>
        //
        //                     <img src={userData.projects[2].cover} className={'absolute w-full h-full object-cover z-0 '}/>
        //                 </div>
        //                 <div className={'relative flex flex-col w-full h-1/3 px-2 sm:px-0  '}>
        //                     <div className={'w-full h-1/4  py-4 sm:py-10  flex items-center justify-between relative text-sm sm:text-md md:text-lg text-stone-600/70'}>
        //                         <span> {userData.projects[2].product}</span>
        //                         <div className={'flex justify-between gap-4'}>
        //                             <span>  {userData.projects[2].form} </span>
        //                             <span>  {userData.projects[2].year}  </span>
        //                         </div>
